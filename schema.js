...
// const JurnalUmumType = new GraphQLObjectType({
// 	name: 'JurnalUmum',
// 	fields: () => ({
// 		id: { type: GraphQLID },
// 		pemasukans: {
...
const TransaksiType = new GraphQLObjectType({
  ...
  fields: () => ({
    ...
    klientagihan: {
      ...
      resolve(parent, args) {
        if (parent.klientagihan_id === "") {
          return null;
        } else return KlienTagihan.findById(parent.klientagihan_id);
      },
    },
    klien: {
      type: ClientType,
      resolve(parent, args) {
        if (parent.klien_id === "") {
          return null;
        } else return Client.findById(parent.klien_id);
      },
    },
    proyek: {
      type: ProyekType,
      resolve(parent, args) {
        if (parent.proyek_id === "") {
          return null;
        } else return Proyek.findById(parent.proyek_id);
      },
    },
    ...
    jenis_transaksi: { type: GraphQLString },
  }),
});
...
const PengeluaranType = new GraphQLObjectType({
  ...
  fields: () => ({
    ...
    akun_debit: {
      ...
      resolve(parent, args) {
        return AkunDebitKredit.findById(parent.akun_debit);
      },
    },
    akun_kredit: {
      type: AkunDebitKreditType,
      resolve(parent, args) {
        return AkunDebitKredit.findById(parent.akun_kredit);
      },
    },
  }),
});
...
const RootQuery = new GraphQLObjectType({
  ...
  fields: {
    ...
    transaksi: {
      ...
      args: { id: { type: GraphQLID } },
      resolve(parent, args) {
        return Transaksi.findById(args.id);
      },
    },
    transaksis: {
  ...
  fields: {
    ...
    addTransaksi: {
      ...
      args: {
        ...
        jenis_transaksi: { type: new GraphQLNonNull(GraphQLString) },
      },
      resolve(parent, args) {
        let request = new Transaksi({
          kode: args.kode,
          ...
          jenis_transaksi: args.jenis_transaksi,
        });
        return request.save();
      },
    },
    ...
    hapusTransaksi: {
      ...
      args: { id: { type: GraphQLID } },
      resolve(parent, args) {
        return Transaksi.deleteOne({ _id: args.id });
      },
    },
    //----------------------------------------------------------------------------//
    addPengeluaran: {
    ...
    updatePengeluaran: {
      ...
      resolve(parent, args) {
        return Pengeluaran.findOneAndUpdate(
          { _id: args.id },
          {
            kode: args.kode,
            tanggal_transaksi: args.tanggal_transaksi,
    ...
    updateAkunDebitKredit: {
      ...
      resolve(parent, args) {
        return AkunDebitKredit.findOneAndUpdate(
          { _id: args.id },
          {
            kode_akun: args.kode_akun,
            nama_akun: args.nama_akun,
