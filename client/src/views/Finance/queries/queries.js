...
`;
const addTransaksiMutation = gql`
  mutation(
...
`;
const updateTransaksiMutation = gql`
  mutation(
    $id: ID!
    $klientagihan_id: String!
    $klien_id: String!
...
`;
const hapusTransaksiMutation = gql`
  mutation($id: ID!) {
