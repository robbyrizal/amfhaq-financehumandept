...
class JurnalUmum extends Component {
  ...
  displayJurnalUmum() {
    ...
    if (this.state.jumlahnomor === 0) {
      this.setState({ jumlahnomor: no });
    }
    if (this.state.jumlahdebit === 0) {
      this.setState({ jumlahdebit: totaldebit });
    }
    if (this.state.jumlahkredit === 0) {
      this.setState({ jumlahkredit: totalkredit });
    }
          ...
          <Col md="12">
            <Card>
              <CardHeader>
                ...
                Jurnal Umum - {this.displaytanggal()}
              ...
              <CardBody>
                ...
                {/* <Table hover bordered striped responsive size="sm">
                  ...
                  <tbody>{this.displayPengeluaran()}</tbody>
                </Table> */}
                ...
                <Table hover bordered striped responsive size="sm">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      >
                        Rp {this.state.jumlahdebit.toLocaleString("id")}
                      </td>
                      <td
                        style={{
                          textAlign: "right",
                      ...
                      >
                        {" "}
                        Rp {this.state.jumlahkredit.toLocaleString("id")}
                      </td>
                    </tr>
                  </tbody>
                </Table>
