...
import {getPengeluaransQuery, getKlienTagihansQuery, addPengeluaranMutation, hapusPengeluaranMutation, getAkunDebitKreditsQuery} from '../queries/queries';
import './index.css';
      ...
      return data.pengeluarans.map(pengeluaran => {
          ...
          return(
            <tr key={pengeluaran.id}>
              ...
              <td>
                <Button onClick={this.onDelete.bind(this, pengeluaran.id)} color="danger" size="sm">
  ...
  displayKlien(){
    ...
    if(data.loading){
      ...
      return data.klientagihans.map(klientagihan => {
        return(
          <option key={klientagihan.id} value={klientagihan.id}> {klientagihan.nama_klien} </option>
        );
      });
    }
  }
        ...
        <Modal isOpen={this.state.modalIsOpen}>
          ...
          <ModalBody>
            ...
            <FormGroup>
                ...
                <Input type="select" id="vendor" onChange={(e) =>this.setState({nama_vendor:e.target.value})} required >
              ...
              <InputGroup>
                ...
                <Input type="number" id="jumlahbiaya" placeholder="Masukkan Jumlah Biaya" className="text-align-right" onChange={(e) =>this.setState({jumlah_dana:e.target.value})} required /> 
              ...
              <InputGroup>
                <InputGroupAddon addonType="prepend">Rp.</InputGroupAddon>
                <Input type="number" id="terbayar" placeholder="Masukkan Jumlah Terbayar" className="text-align-right" onChange={(e) =>this.setState({jumlah_bayar:e.target.value})} required />
                <InputGroupAddon addonType="append">.00</InputGroupAddon>
              </InputGroup>
              </FormGroup>
              <FormGroup>
